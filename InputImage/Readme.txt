...
Wait for the final results to come. ( It may take several minutes depending on the input image size and configuration of computer in which it is running- as the code is not highly optimized)
